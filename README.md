...
> [!NOTE]
> Si el programa no se ejecuta con este comando, prueba a ejecutarlo con: *python Ejercicio#1_FiltroIntro_SalamancaDante.py*
...
> [!NOTE]
> Si el programa no se ejecuta con este comando, prueba a ejecutarlo con: *python Ejercicio#2_FiltroIntro_SalamancaDante.py*
...
> [!NOTE]
> Si el programa no se ejecuta con este comando, prueba a ejecutarlo con: *python Ejercicio#3_FiltroIntro_SalamancaDante.py*
...
> [!NOTE]
> Si el programa no se ejecuta con este comando, prueba a ejecutarlo con: *python Ejercicio#4_FiltroIntro_SalamancaDante.py*
...
Para finalizar, una vez completadas todas las iteraciones del bucle **for** (es decir, una vez *i* tome el valor de 9), el programa continúa y muestra el número mayor (*xMax*) y menor (*xMin*) de los dados por el usuario (*línea 14* / *línea 15*); luego termina el proceso.
